...
def constantFiniteEventSourceBound
    : CheckedEventSource EventB.Theory.empty constantFiniteVariantProject constantFinPOExact.obligation.component "hold" := by
...
def constantFiniteVariantSourceBound
    : CheckedVariantSource constantFiniteVariantProject constantFinPOExact.obligation.component := by
