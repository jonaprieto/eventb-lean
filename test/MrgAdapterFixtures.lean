...
def mrgEventSourceBound
    : CheckedEventSource EventB.Theory.empty mrgAdapterProject mrgPO.obligation.component "merge"
    := by
...
def mrgMergeSourceBound
    : CheckedMergeSource EventB.Theory.empty mrgAdapterProject mrgPO.obligation.component "merge"
    := by
  have component : mrgPO.obligation.component = "B" := by native_decide
  rw [component]
...
def mrgGuardSourceBound
    : CheckedGuardSource EventB.Theory.empty mrgAdapterProject mrgPO.obligation.component "merge"
    := by
  have component : mrgPO.obligation.component = "B" := by native_decide
  rw [component]
...
theorem mrgLeftAssignment
    : mrgLeftEventSource.assignmentAction 128 mrgTransition
    := by
...
theorem mrgRightAssignment
    : mrgRightEventSource.assignmentAction 128 mrgTransition
    := by
...
theorem mrgLeftGuardHolds
    : mrgLeftGuardSource.holds 128 mrgTransition
    := by
...
theorem mrgRightGuardHolds
    : mrgRightGuardSource.holds 128 mrgTransition
    := by
...
theorem mrgAssignment
    : mrgEventSourceBound.assignmentAction 128 mrgTransition
    := by
...
private
theorem mrgSemantic
    : splitSimulationSemantic mrgContract mrgBranches
    := by
  intro _ _ _ _ _ _
...
example
    : ∀ c c' a,
      True →
      mrgAdapter.contract.concreteEvent.grd c →
