...
example
    : splitSimulationSemantic splitContract sourceBranches
    := by
...
example
    : ¬ splitSimulationSemantic splitContract [("foreign", foreignBranch)]
    := by
  intro semantic
...
example
    : ¬ splitSimulationSemantic splitContract [("left", foreignBranch), ("right", rightBranch)]
    := by
  intro semantic
